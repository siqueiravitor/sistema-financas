...
if (!$id) {
    header("Location: ../?alert=1&msg=Tela não encontrada");
}

$selectScreen = "select name from module where id = $id";
$queryScreen = mysqli_query($con, $selectScreen);
$screenName = mysqli_fetch_array($queryScreen)[0];
?>
<!doctype html>
<html lang="pt-br">
    <head>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row"> 
                        <div class="col-md-12 header" style="">
                            <h5 class="text-muted text-center space-1">Módulo - <?= $screenName ?></h5>
                        </div>
                        <div class="col-md-4">
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    <form method="POST" action="./include/gScreen.php">
                                        <div class="border-bottom mb-4">
                                            <h5 class="text-muted text-center space-1">Cadastrar nova tela</h5>
                                        </div>
                        ...
                        <div class="col-md-8">
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    <div class="border-bottom mb-4">
                                        <h5 class="text-muted text-center space-1">Telas cadastradas</h5>
                                    </div>
