! function(a, b) {
    ...
    var Kb = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        Lb = "Janeiro_Fevereiro_Março_Abril_Maio_Junho_Julho_Agosto_Setembro_Outubro_Novembro_Dezembro".split("_"),
        Mb = "Jan_Fev_Mar_Abr_Mai_Jun_Jul_Ago_Set_Out_Nov_Dez".split("_"),
        Nb = wb,
        Ob = wb;
    E("w", ["ww", 2], "wo", "Semana"), E("W", ["WW", 2], "Wo", "isoWeek"), z("week", "w"), z("isoWeek", "W"), C("week", 5), C("isoWeek", 5), H("w", mb), H("ww", mb, ib), H("W", mb), H("WW", mb, ib), L(["w", "ww", "W", "WW"], function(a, b, c, d) {
        b[d.substr(0, 1)] = r(a)
    ...
    var Pb = "Domingo_Segunda_Terça_Quarta_Quinta_Sexta_Sábado".split("_"),
        Qb = "Dom_Seg_Ter_Qua_Qui_Sex_Sab".split("_"),
